...
:init
  ...
  set AUXFILES=aux bbl blg dvi glo gls hd idx ilg ind ist log los out tmp toc
  ...
  set TDSFILES=%CTANFILES% bst cfg cls tex sty 
...
:file2tdsdir
  ...
  if /i "%~x1" == ".bst" set TDSDIR=bibtex\bst\%PACKAGE%
